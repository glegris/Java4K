									...
									if (y > 123) {
										...
										world[y][x] = level == 3 ? (world[y + 1][x] == TILE_EMPTY ? TILE_DOUBLE_UP : TILE_SOLID) : level == 4 ? (world[y + 1][x] == TILE_EMPTY ? TILE_EXCLAMATION
												...
												: level == 6 ? (world[y + 1][x] == TILE_EMPTY ? TILE_SOLID : x < 4 ? TILE_DOUBLE_RIGHT : TILE_DOUBLE_LEFT)
														: level == 7 ? (world[y + 1][x] == TILE_EMPTY ? TILE_SOLID : (x & 1) == 1 ? TILE_DOWN : TILE_DOUBLE_UP)
																: level == 8 ? (y & 3) == 0 ? TILE_QUESTION : TILE_SOLID : level == 9 ? (y & 3) == 0 ? TILE_SOLID : TILE_PAUSE : level == 10 ? z
																		: level == 11 ? y < 36 ? TILE_GREEN : y < 68 ? (world[y + 1][x] == TILE_EMPTY ? TILE_SOLID : x < 4 ? TILE_RIGHT : TILE_LEFT)
																				: y < 100 ? (world[y + 1][x] == TILE_EMPTY ? TILE_SOLID : x < 4 ? TILE_DOUBLE_RIGHT : TILE_DOUBLE_LEFT)
																						: TILE_EXCLAMATION : level == 12 ? y < 36 ? TILE_DOUBLE_UP : y < 68 ? TILE_EXCLAMATION : y < 100 ? TILE_GREEN
																				: z : level == 13 ? y < 36 ? x < 4 ? TILE_DOUBLE_RIGHT : TILE_DOUBLE_LEFT : y < 40 ? TILE_SOLID : y < 68 ? TILE_PAUSE
