...
public class A extends Applet implements Runnable {
	...
	public void run() {
		...
		BufferedImage lifeOrb = new BufferedImage(29, 29, BufferedImage.TYPE_INT_ARGB);
		BufferedImage manaOrb = new BufferedImage(29, 29, BufferedImage.TYPE_INT_ARGB);
		BufferedImage stairs = new BufferedImage(66, 33, BufferedImage.TYPE_INT_ARGB);
		BufferedImage tile = new BufferedImage(128, 64, BufferedImage.TYPE_INT_ARGB);
		BufferedImage backBuffer = new BufferedImage(256, 192, BufferedImage.TYPE_INT_RGB);
		BufferedImage backGroundImage = new BufferedImage(4096, 2048, BufferedImage.TYPE_INT_RGB);

		Graphics2D g2d;
		Graphics2D g2dScr = backBuffer.createGraphics();
		...
		} // end while (thr == gameloop) <=> main loop
