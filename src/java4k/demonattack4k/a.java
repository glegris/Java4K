				...
				for (i = demons.size() - 1; i >= 0; i--) {
					...
					if (demon[DEMON_EXPLODING] == 1) {
						if (demon[DEMON_BIRD] == 1) {
							g.drawImage(enemySprites[level][6 + (int) demon[DEMON_EXPLODING_INDEX]], (int) demon[DEMON_X], (int) demon[DEMON_Y], (int) demon[DEMON_X] + 8, (int) demon[DEMON_Y] + 8, 0,
									0, 8, 8, null);
						} else {
							g.drawImage(enemySprites[level][(level > 3 ? 6 : 3) + (int) demon[DEMON_EXPLODING_INDEX]], (int) demon[DEMON_X], (int) demon[DEMON_Y], null);
						}
					} else if (demon[DEMON_FORMING] == 1) {
						g.drawImage(enemySprites[level][j + 3], (int) demon[DEMON_X], (int) demon[DEMON_Y], (int) demon[DEMON_X] + 32, (int) demon[DEMON_Y] + 8, 0, 0, 8, 8, null);
						g.drawImage(enemySprites[level][j + 3], (int) demon[DEMON_X2], (int) demon[DEMON_Y], (int) demon[DEMON_X2] + 32, (int) demon[DEMON_Y] + 8, 7, 0, 15, 8, null);
					} else {
						g.drawImage(enemySprites[level][demon[DEMON_BIRD] == 1 ? 9 + j : j], (int) demon[DEMON_X], (int) demon[DEMON_Y], null);
					}
				}

				if (playerExploding > 0) {
					// draw player's ship exploding
					g.drawImage(sprites[(playerExploding >> 3) + 15], (int) playerX - 4, 153, null);
				} else {
					// draw player bullet
